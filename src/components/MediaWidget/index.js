	...
	return (
		<div className="d-flex flex-column align-items-center justify-content-between">
			<div className={`${MediaWidgetStyle["big-circle"]} my-1 position-relative rounded-circle px-2`}>
				<i onClick={onClickBigBtn /*didn't put it in parent because of event bubbling*/} className={`${MediaWidgetStyle["icon"]} ${((type === "video") && "bi-play-circle") || ((type === "audio") && "bi-headphones") || ((type === "img") && "bi-image")}`}></i>
